export const es = {
  ...
  // --- Landing ---
  landing: "Inicio",
  landingTitle: "El dinero cruza fronteras en segundos, no en días.",
  landingLead: "La alternativa a la banca corresponsal para empresas e instituciones.",
  landingCta: "Abrir la aplicación",
  landingCtaSecondary: "Ver el registro público",
  q1Title: "Llega hoy",
  q1Body: "El pago está disponible mientras una transferencia tradicional todavía viaja entre bancos.",
  q2Title: "Un solo costo",
  q2Body: "Lo conocés antes de enviar. Sin cargos que aparecen en cada intermediario.",
  q3Title: "Nada oculto",
  q3Body: "Cada operación queda registrada públicamente. Podés comprobarla vos, sin pedirnos nada.",
